...
export async function POST(request: NextRequest) {
    try {
        ...
        void appendQuestEvent(supabase, {
            ...
            user_id: user.id,
            room: 'writing',
            event_key: 'manifest_finalize_started',
            level: 'info',
            status: 'active',
            message: 'Manifest finalization started.',
        });
        ...
        void appendQuestEvent(supabase, {
            ...
            user_id: user.id,
            room: 'writing',
            event_key: 'manifest_finalize_completed',
            level: 'success',
            status: 'done',
            message: `Manifest finalized for hypothesis \"${manifest.hypothesis.title}\".`,
        });
